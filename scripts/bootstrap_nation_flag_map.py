...
EXTRA_ALIASES: dict[str, list[str]] = {
    ...
    "스페인": ["Spain", "ESP"],
    "브라질": ["Brazil", "BRA"],
    "네델란드": ["Netherlands", "NED"],
    "인도네이사": ["인도네시아", "Indonesia"],
}

FLAGS = [
    {"flag_id": "flags_03", "file": "flags_03.png", "name_ko": "카타르"},
    {"flag_id": "flags_05", "file": "flags_05.png", "name_ko": "에콰도르"},
    {"flag_id": "flags_07", "file": "flags_07.png", "name_ko": "세네갈"},
    {"flag_id": "flags_09", "file": "flags_09.png", "name_ko": "네델란드"},
    ...
    {"flag_id": "flags_15", "file": "flags_15.png", "name_ko": "미국"},
    {"flag_id": "flags_17", "file": "flags_17.png", "name_ko": "웨일스"},
